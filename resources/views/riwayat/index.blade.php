...
@section('content')
    <div class="card my-5">
        <div class="card-body">
            <h4 class="card-title">Rekap Laporan Fasilitas</h4>
            <p>Rekap laporan fasilitas sarana dan prasarana kampus</p>

            <a href="{{ url('riwayat-laporan/exportRekap') }}" class="btn btn-primary my-2"><i class="fas fa-download mr-2"></i>Unduh Rekap Laporan</a>
            <a href="{{ url('riwayat-laporan/chartTren') }}" class="btn btn-success my-2"><i class="fas fa-download mr-2"></i>Unduh Chart Laporan</a>
        ...
        $(function() {
            tableLaporanFasilitas = $('#tabel-laporan').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'pelapor',
                        name: 'laporanFasilitas.laporan.pengguna.nama'
                    },
                    {
                        data: 'fasilitas',
                        name: 'laporanFasilitas.fasilitas.nama_fasilitas'
                    },
                    {
                        data: 'status',
