<form id="form-import" action="{{ route('ruangan.fasilitas.import_ajax', $ruangan) }}" method="POST" enctype="multipart/form-data">
    @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <a href="{{ asset('assets/excel/template_data_fasilitas.xlsx') }}"
          ...
          <div class="form-group">
            ...
            <small id="error-file_fasilitas" class="form-text text-danger"></small>
          </div>
        </div>
