<form id="form-import" action="{{ route('gedung.import_ajax') }}" method="POST" enctype="multipart/form-data">
    @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <a href="{{ asset('assets/excel/template_data_gedung.xlsx') }}"
          ...
          <div class="form-group">
            ...
            <small id="error-file_gedung" class="form-text text-danger"></small>
          </div>
        </div>
