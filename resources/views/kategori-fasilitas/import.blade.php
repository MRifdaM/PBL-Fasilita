<form id="form-import" action="{{ route('kategoriF.import_ajax') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal-dialog modal-lg w-50" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Import Kategori Fasilitas</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Download Template</label>
                    <a href="{{ asset('assets/excel/template_data_kategori_fasilitas.xlsx') }}"
                ...
                <div class="form-group">
                    ...
                    <small id="error-file_kategori" class="form-text text-danger"></small>
                </div>
            </div>
