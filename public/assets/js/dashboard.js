    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        scales: {
          x: [{
            grid: { display: false },
            ticks: { padding: 10, color: "#6C7383" }
          }],
          y: [{
            grid: { color: "#f2f2f2", drawBorder: false },
            ticks: { stepSize: 200, min: 0, color: "#6C7383" }
          }]
        },
        elements: {
          line: { tension: 0.35 },
  ...
  $.ajax({
    ...
    var SalesChart = new Chart(ctx, {
      ...
      options: {
        ...
        scales: {
          yAxes: [{ beginAtZero: true, ticks:{ callback: v => v+'', fontColor:"#6C7383" },
                    gridLines:{ color:"#F2F2F2", drawBorder:false } }],
          xAxes: [{ ticks:{ fontColor:"#6C7383" }, gridLines:{ display:false }, barPercentage:1 }]
        },
